import{r as A,i as v,C as S,e as k,E as Y,t as Ce,F as J,m as Ee,u as b,v as ke,w as X,x as Q,y as Z,z as ee,L as Re,A as U}from"./index.esm-Cb14E9aF.js";const te="@firebase/installations",N="0.6.24";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt{constructor(t){this.app=t}_delete(){return delete p[this.app.options.appId],Promise.resolve()}}let p={},z=[];const G={};let T="dataLayer",Se="gtag",H,g,M=!1;function Zt(e){if(M)throw d.create("already-initialized");e.dataLayerName&&(T=e.dataLayerName),e.gtagName&&(Se=e.gtagName)}function Ht(){const e=[];if(X()&&e.push("This is a browser extension environment."),Q()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,i)=>`(${i+1}) ${a}`).join(" "),n=d.create("invalid-analytics-context",{errorInfo:t});u.warn(n.message)}}function Kt(e,t,n){Ht();const a=e.options.appId;if(!a)throw d.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)u.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw d.create("no-api-key");if(p[a]!=null)throw d.create("already-exists",{id:a});if(!M){At(T);const{wrappedGtag:r,gtagCore:s}=Et(p,z,G,T,Se);g=r,H=s,M=!0}return p[a]=zt(e,z,G,t,H,T,n),new Gt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function en(e=Ee()){e=b(e);const t=k(e,E);return t.isInitialized()?t.getImmediate():Wt(e)}function Wt(e,t={}){const n=k(e,E);if(n.isInitialized()){const i=n.getImmediate();if(ke(t,n.getOptions()))return i;throw d.create("already-initialized")}return n.initialize({options:t})}async function tn(){if(X()||!Q()||!Z())return!1;try{return await ee()}catch{return!1}}function nn(e,t,n){e=b(e),Lt(g,p[e.app.options.appId],t,n).catch(a=>u.error(a))}async function an(e){return e=b(e),Ut(g,p[e.app.options.appId])}function rn(e,t,n){e=b(e),qt(g,p[e.app.options.appId],t,n).catch(a=>u.error(a))}function Yt(e,t,n){e=b(e),jt(g,p[e.app.options.appId],t,n).catch(a=>u.error(a))}function sn(e,t){e=b(e),Bt(p[e.app.options.appId],t).catch(n=>u.error(n))}function on(e){g?g("set",e):ve(e)}function Jt(e,t,n,a){e=b(e),xt(g,p[e.app.options.appId],t,n,a).catch(i=>u.error(i))}function cn(e){g?g("consent","update",e):Ae(e)}const K="@firebase/analytics",W="0.10.24";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
